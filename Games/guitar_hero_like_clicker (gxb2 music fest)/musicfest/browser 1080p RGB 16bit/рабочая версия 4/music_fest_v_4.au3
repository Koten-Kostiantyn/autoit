...
Func pixelget1()
   $fcolor = PixelGetColor(333, 214) ;229
   Return $fcolor
EndFunc;

Func pixelget2()
   $fcolor = PixelGetColor(461, 214)
   Return $fcolor
EndFunc;

Func pixelget3()
   $fcolor = PixelGetColor(590, 214)
   Return $fcolor
EndFunc;

Func pixelget4()
   $fcolor = PixelGetColor(717, 214)
   Return $fcolor
EndFunc;
...
Func count_pixel_and_otput_to_console_and_do_action( _
	...
	If $new_memory_pixel_counter > 45 Then
...
Func normal_click_first()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "d")
	; MouseClick("left", 737, 800, 1)
EndFunc ;

Func hold_click_first()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{d down}")
	; MouseMove(737, 800, 1)
	;MouseDown("left")
EndFunc
...
Func unclick_first()
	Sleep(435)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{d up}")
	; MouseMove(737, 800, 1)
	;MouseUp("left")
EndFunc
...
Func normal_click_second()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "f")
	; MouseClick("left", 872, 800, 1)
EndFunc ;

Func hold_click_second()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{f down}")
	; MouseMove(872, 800, 1)
	;MouseDown("left")
EndFunc
...
Func unclick_second()
	Sleep(435)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{f up}")
	; MouseMove(872, 800, 1)
	;MouseUp("left")
EndFunc
...
Func normal_click_third()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "j")
	; MouseClick("left", 1007, 800, 1)
EndFunc ;

Func hold_click_third()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{j down}")
...
Func unclick_third()
	Sleep(435)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{j up}")
	; MouseMove(1007, 800, 1)
	;MouseUp("left")
EndFunc
...
Func normal_click_four()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "k")
	; MouseClick("left", 1141, 800, 1)
EndFunc ;

Func hold_click_four()
	Sleep(455)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{k down}")
...
Func unclick_four()
	Sleep(435)
	ControlSend("Girls X Battle 2 - Girls X Battle 2 - Carolgames Games - Google Chrome", "Chrome Legacy Window", "" , "{k up}")
	; MouseMove(1141, 800, 1)
	;MouseUp("left")
EndFunc
