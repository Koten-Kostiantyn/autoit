...
Func pixelget1()
   $fcolor = PixelGetColor(274, 106)
   Return $fcolor
EndFunc;

Func pixelget2()
   $fcolor = PixelGetColor(345, 106)
   Return $fcolor
EndFunc;

Func pixelget3()
   $fcolor = PixelGetColor(415, 106)
   Return $fcolor
EndFunc;

Func pixelget4()
   $fcolor = PixelGetColor(485, 106)
   Return $fcolor
EndFunc;
...
Func check_action_time_and_do_action_if_it_is_time_CLICK($actual_click_counter)
	...
	Local $c_button = $global_click_button_array[$actual_click_counter]
